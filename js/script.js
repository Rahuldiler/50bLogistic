...
document.addEventListener("DOMContentLoaded", function() {
	...
	// Delay showing modal by 5 seconds
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const numbers = document.querySelectorAll('.project_done h2');
    ...
    const observer = new IntersectionObserver((entries, observer) => {
        entries.forEach((entry, index) => {
            if (entry.isIntersecting) {
                ...
                }, index * 200); // Adjust delay to 200ms for a smoother sequence
                observer.unobserve(entry.target); // Stop observing the current number
            }
        });
    }, {
        threshold: 0.1
